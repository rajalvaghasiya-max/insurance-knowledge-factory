...
STAR_COMPREHENSIVE_COVERAGE = ProductCoverageRecord(
    ...
    concepts=(
        ...
        ConceptCoverageRecord(
            ...
            decision_support_ready=False,
            limitations=(
                "All current base-policy clauses explicitly expressed as waiting periods are governed: the standard 30-day initial wait, standard 36-month PED, optional PED buy-back to 12 months, 24-month specified-disease/procedure wait, 24-month Delivery and New Born wait, 36-month Bariatric Surgery wait, and 30-day Preventive Health Check-up wait.",
                "The optional PED buy-back remains conditional: a customer-specific 12-month PED wait must not be inferred without evidence that the optional cover was validly selected.",
                "Delivery and New Born preserves the 24-month reset after a Section II.14.A claim plus its stated Self/Spouse continuity and policy-in-force conditions.",
                "The Section II.17 Dental/Ophthalmic three-year continuous-coverage cycle is classified separately as time-gated benefit eligibility because the wording does not express it as a waiting period.",
                "Concept certification does not authorize publication, comparison readiness, decision-support readiness, customer-specific eligibility, claim-payment prediction, or exact first-active calendar arithmetic for the standard 30-day initial wait.",
            ),
        ),
    ),
)
