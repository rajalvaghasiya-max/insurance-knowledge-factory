...
OUTPUT_PATH = Path("docs/architecture/CURRENT_HEALTH_INSURANCE_INTELLIGENCE_COVERAGE_REVIEW.md")


def write_current_health_coverage_review(output_path: Path = OUTPUT_PATH) -> Path:
    """Render current Health coverage using canonical UTF-8/LF bytes."""
...
def main() -> None:
    print(write_current_health_coverage_review())
