...
| Capability | Lifecycle | Reuse | Authority role | Lineage | Ownership boundary | Fingerprint |
| --- | --- | --- | --- | --- | --- | --- |
| `II.CONTEXT.BUILDER`<br>Governed Context Builder | `ACTIVE` | `REUSE` | Determines context sufficiency only; textual mentions and candidate references do not establish governed insurance identity. | None | `insurance_intelligence/context`<br>`insurance_intelligence/contracts/context.py` | `a38ea0b6e8e2` |
...
| Capability | Lifecycle | Reuse | Authority role | Lineage | Ownership boundary | Fingerprint |
| --- | --- | --- | --- | --- | --- | --- |
| `II.EVALUATION.MO021_PIPELINE_BASELINE`<br>MO-021 Deterministic Pipeline Evaluation Baseline | `ACTIVE` | `REUSE` | Evaluation authority only. The active canonical path consumes already-produced orchestration StageResult objects and released response artifacts; it does not execute, replay, reinterpret, or bypass insurance-intelligence stages. | None | `insurance_intelligence/evaluation/runner.py`<br>`insurance_intelligence/evaluation/assertions.py`<br>`insurance_intelligence/evaluation/service.py`<br>`insurance_intelligence/evaluation/scenarios.py`<br>`insurance_intelligence/evaluation/fixtures.py`<br>`insurance_intelligence/evaluation/canonical_capture.py`<br>`insurance_intelligence/evaluation/canonical_final.py`<br>`insurance_intelligence/contracts/evaluation.py` | `abd4248406ed` |
...
| Capability | Lifecycle | Reuse | Authority role | Lineage | Ownership boundary | Fingerprint |
| --- | --- | --- | --- | --- | --- | --- |
| `II.EXPLANATION.AUTHORITY_ENFORCEMENT`<br>Authority-Enforced Explanation Entry | `ACTIVE` | `REUSE` | Controls entry into the existing evidence-locked Explanation Generator; it does not add findings or recommendation authority. | None | `insurance_intelligence/authority_enforced_explanation.py` | `d2251683794e` |
...
| `II.ORCHESTRATION.EXECUTION_RUNTIME`<br>Governed Full-Cycle Execution Runtime | `ACTIVE` | `REUSE` | Execution coordinator only; stage-order authority remains II.ORCHESTRATION.CANONICAL_GUARDED_ORDER and semantic authority remains with each guarded stage capability. | None | `insurance_intelligence/orchestration/service.py`<br>`insurance_intelligence/orchestration/execution_state.py`<br>`insurance_intelligence/orchestration/intelligence_adapters.py`<br>`insurance_intelligence/orchestration/knowledge_adapters.py`<br>`insurance_intelligence/orchestration/user_answer_evidence_adapter.py`<br>`insurance_intelligence/orchestration/product_instance_binding.py`<br>`insurance_intelligence/orchestration/real_response_prefix.py`<br>`insurance_intelligence/orchestration/real_response_reasoning.py`<br>`insurance_intelligence/orchestration/real_response_decision.py`<br>`insurance_intelligence/orchestration/real_response_explanation.py`<br>`insurance_intelligence/orchestration/real_response_assembly.py`<br>`insurance_intelligence/orchestration/real_response_rendering.py` | `8fd882da01d2` |
...
| Capability | Lifecycle | Reuse | Authority role | Lineage | Ownership boundary | Fingerprint |
| --- | --- | --- | --- | --- | --- | --- |
| `II.PLANNING.REASONING_PLANNER`<br>Deterministic Reasoning Planner | `ACTIVE` | `REUSE` | Planning authority only; it may declare required operations but does not retrieve evidence, calculate, interpret clauses, compare products, assess suitability, recommend, or generate answers. | None | `insurance_intelligence/planning`<br>`insurance_intelligence/contracts/reasoning_plan.py` | `7b29c9f0ab0e` |
...
| Capability | Lifecycle | Reuse | Authority role | Lineage | Ownership boundary | Fingerprint |
| --- | --- | --- | --- | --- | --- | --- |
| `II.REASONING.ENGINE`<br>Deterministic Reasoning Engine | `ACTIVE` | `REUSE` | May emit only registered finding types and derivations; it does not authorize recommendation or suitability outcomes. | None | `insurance_intelligence/reasoning`<br>`insurance_intelligence/contracts/reasoning.py` | `834ae203e120` |
